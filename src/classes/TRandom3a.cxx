...
TRandom3State::TRandom3State() 
{
   TRandom3a tmpState;
   TRandom3State state = tmpState.GetState();
   fCount624 = state.fCount624;
   memcpy(fMt, state.fMt, 624*sizeof(UInt_t));
}

//______________________________________________________________________________
TRandom3State::TRandom3State(const UInt_t* mt, const Int_t count624)
{
   fCount624 = count624;
   memcpy(fMt,mt,624*sizeof(UInt_t));
}
...
//______________________________________________________________________________
void TRandom3a::RndmArray(Int_t n, Float_t *array)
{
...
//______________________________________________________________________________
void TRandom3a::RndmArray(Int_t n, Double_t *array)
{
  // Return an array of n random numbers uniformly distributed in ]0,1]
...
//______________________________________________________________________________
void TRandom3a::SetSeed(UInt_t seed)
{
...
//______________________________________________________________________________
TRandom3State TRandom3a::GetState() const
{
   return TRandom3State(fMt, fCount624);
}

//______________________________________________________________________________
void TRandom3a::SetState(const TRandom3State& state)
{
   fCount624 = state.fCount624;
   memcpy(fMt, state.fMt, 624*sizeof(UInt_t));
}
