...
//  BoolNode - base class for Boolean operations between two shapes.
//===============
...
//
//    Union - representing the Boolean  union of two positioned shapes
//
//    Subtraction - representing the Boolean subtraction of two positioned 
//                shapes
// 
//    Intersection - representing the Boolean intersection of two positioned
//                shapes
//_____________________________________________________________________________
...
// Default constructor
      ...
      Info("BoolNode","Default Constructor");
	#endif
	fLeft     = 0;
   fRight    = 0;
   fLeftMat  = 0;
...
//_____________________________________________________________________________
BoolNode::BoolNode(const char *expr1, const char *expr2)
{
// Constructor called by CompositeShape providing 2 subexpressions for the 2 branches.
   #ifdef PRINT_CONSTRUCTORS
...
// --- deletion of components handled by TGeoManager class.
	#ifdef PRINT_CONSTRUCTORS
      Info("BoolNode","Destructor");
   #endif
}
//_____________________________________________________________________________
Bool_t BoolNode::MakeBranch(const char *expr, Bool_t left)
{
...
// component elements (composite shapes and boolean nodes). Returns true on success.
   ...
   switch (boolop) {
      ...
      case 1:
         ...
         newshape += "+";
         newshape += sright;
         shape = new CompositeShape(newshape.Data());
         break;
      case 2:
...
//_____________________________________________________________________________
void BoolNode::Paint(Option_t * option)
{
// Special schema for feeding the 3D buffers to the painter client.
   ...
   //fLeft->Paint(option);
   if (CompositeShape *left = dynamic_cast<CompositeShape *>(fLeft)) left->PaintComposite(option);
   else {
   ...
   *glmat = &mat;
   ...
   //fRight->Paint(option);
   if (CompositeShape *right = dynamic_cast<CompositeShape *>(fRight)) right->PaintComposite(option);
   else {
...
//_____________________________________________________________________________
void BoolNode::RegisterMatrices()
{
// Register all matrices of the boolean node and descendents.
   ...
   if (fLeft->IsComposite()) ((CompositeShape*)fLeft)->GetBoolNode()->RegisterMatrices();
   if (fRight->IsComposite()) ((CompositeShape*)fRight)->GetBoolNode()->RegisterMatrices();
}
//_____________________________________________________________________________
void BoolNode::SavePrimitive(ostream &out, Option_t *option /*= ""*/)
{
...
//_____________________________________________________________________________
void Union::Paint(Option_t *option)
{
// Paint method.
   TVirtualViewer3D *viewer = gPad->GetViewer3D();
...
// Default constructor
	#ifdef PRINT_CONSTRUCTORS
      Info("Union","Default Constructor");
   #endif
}
//_____________________________________________________________________________
Union::Union(const char *expr1, const char *expr2)
          :BoolNode(expr1, expr2)
{
// Constructor
	#ifdef PRINT_CONSTRUCTORS
...
// --- deletion of components handled by TGeoManager class.
   #ifdef PRINT_CONSTRUCTORS
      Info("Union","Destructor");
   #endif
}
//_____________________________________________________________________________
void Union::ComputeBBox(Double_t &dx, Double_t &dy, Double_t &dz, Double_t *origin)
{
...
//_____________________________________________________________________________
Bool_t Union::Contains(Double_t *point) const
{
...
//_____________________________________________________________________________
void Union::ComputeNormal(Double_t *point, Double_t *dir, Double_t *norm)
{
...
//_____________________________________________________________________________
Int_t Union::DistanceToPrimitive(Int_t /*px*/, Int_t /*py*/)
{
// Compute minimum distance to shape vertices.
   return 9999;
}
//_____________________________________________________________________________
Double_t Union::DistFromInside(Double_t *point, Double_t *dir, Int_t iact,
...
//_____________________________________________________________________________
Double_t Union::DistFromOutside(Double_t *point, Double_t *dir, Int_t iact,
                              Double_t step, Double_t *safe) const
{
...
//_____________________________________________________________________________
void Union::SetPoints(Double_t * /*points*/) const
{
// Fill buffer with shape vertices.
}

//_____________________________________________________________________________
Double_t Union::Safety(Double_t *point, Bool_t in) const
{
...
//_____________________________________________________________________________
void Union::SavePrimitive(ostream &out, Option_t *option /*= ""*/)
{
// Save a primitive as a C++ statement(s) on output stream "out".
   BoolNode::SavePrimitive(out,option);
   out << "   pBoolNode = new Union(";
...
//_____________________________________________________________________________
void Union::SetPoints(Float_t * /*points*/) const
{
// Fill buffer with shape vertices.
}

//_____________________________________________________________________________
void Union::Sizeof3D() const
{
...
ClassImp(Subtraction)

//_____________________________________________________________________________
void Subtraction::Paint(Option_t *option)
{
// Paint method.
   TVirtualViewer3D *viewer = gPad->GetViewer3D();
...
// Default constructor
   #ifdef PRINT_CONSTRUCTORS
      Info("Subtraction","Default Constructor");
   #endif
}

//_____________________________________________________________________________
Subtraction::Subtraction(const char *expr1, const char *expr2)
          :BoolNode(expr1, expr2)
{
// Constructor
   #ifdef PRINT_CONSTRUCTORS
...
// --- deletion of components handled by TGeoManager class.
   #ifdef PRINT_CONSTRUCTORS
      Info("Subtraction","Destructor");
   #endif
}

//_____________________________________________________________________________
void Subtraction::ComputeBBox(Double_t &dx, Double_t &dy, Double_t &dz, Double_t *origin)
{
...
//_____________________________________________________________________________
void Subtraction::ComputeNormal(Double_t *point, Double_t *dir, Double_t *norm)
{
// Normal computation in POINT. The orientation is chosen so that DIR.dot.NORM>0.
   norm[0] = norm[1] = 0.;
   norm[2] = 1.;
...
//_____________________________________________________________________________
Bool_t Subtraction::Contains(Double_t *point) const
{
...
//_____________________________________________________________________________
Int_t Subtraction::DistanceToPrimitive(Int_t /*px*/, Int_t /*py*/)
{
// Compute minimum distance to shape vertices
   return 9999;
}
//_____________________________________________________________________________
Double_t Subtraction::DistFromInside(Double_t *point, Double_t *dir, Int_t iact,
                              Double_t step, Double_t *safe) const
{
...
//_____________________________________________________________________________
Double_t Subtraction::DistFromOutside(Double_t *point, Double_t *dir, Int_t iact,
                              Double_t step, Double_t *safe) const
{
...
//_____________________________________________________________________________
Int_t Subtraction::GetNpoints() const
{
// Returns number of vertices for the composite shape described by this subtraction.
   return 0;
}
//_____________________________________________________________________________
Double_t Subtraction::Safety(Double_t *point, Bool_t in) const
{
// Compute safety distance for a union node;
   Double_t local1[3], local2[3];
   fLeftMat->MasterToLocal(point,local1);
...
//_____________________________________________________________________________
void Subtraction::SavePrimitive(ostream &out, Option_t *option /*= ""*/)
{
// Save a primitive as a C++ statement(s) on output stream "out".
   BoolNode::SavePrimitive(out,option);
   out << "   pBoolNode = new Subtraction(";
   out << fLeft->GetPointerName() << ",";
   out << fRight->GetPointerName() << ",";
   if (!fLeftMat->IsIdentity()) out << fLeftMat->GetPointerName() << ",";
   else                         out << "0,";
...
//_____________________________________________________________________________
void Subtraction::SetPoints(Double_t * /*points*/) const
{
// Fill buffer with shape vertices.
}
//_____________________________________________________________________________
void Subtraction::SetPoints(Float_t * /*points*/) const
{
// Fill buffer with shape vertices.
}
//_____________________________________________________________________________
void Subtraction::Sizeof3D() const
{
// Register 3D size of this shape.
   BoolNode::Sizeof3D();
}
...
ClassImp(Intersection)

//_____________________________________________________________________________
void Intersection::Paint(Option_t *option)
{
// Paint method.
   TVirtualViewer3D *viewer = gPad->GetViewer3D();
...
// Default constructor
   #ifdef PRINT_CONSTRUCTORS
      Info("Intersection","Default Constructor");
   #endif
}

//_____________________________________________________________________________
Intersection::Intersection(const char *expr1, const char *expr2)
          :BoolNode(expr1, expr2)
{
// Constructor
   #ifdef PRINT_CONSTRUCTORS
...
// --- deletion of components handled by TGeoManager class.
   #ifdef PRINT_CONSTRUCTORS
      Info("Intersection","Destructor");
   #endif
}

//_____________________________________________________________________________
void Intersection::ComputeBBox(Double_t &dx, Double_t &dy, Double_t &dz, Double_t *origin)
{
...
//_____________________________________________________________________________
void Intersection::ComputeNormal(Double_t *point, Double_t *dir, Double_t *norm)
{
// Normal computation in POINT. The orientation is chosen so that DIR.dot.NORM>0.
   Double_t local[3], ldir[3], lnorm[3];
   norm[0] = norm[1] = 0.;
...
//_____________________________________________________________________________
Bool_t Intersection::Contains(Double_t *point) const
{
...
//_____________________________________________________________________________
Int_t Intersection::DistanceToPrimitive(Int_t /*px*/, Int_t /*py*/)
{
// Compute minimum distance to shape vertices
   return 9999;
}
...
//_____________________________________________________________________________
Double_t Intersection::DistFromInside(Double_t *point, Double_t *dir, Int_t iact,
                              Double_t step, Double_t *safe) const
{
// Compute distance from a given point inside to the shape boundary.
   if (iact<3 && safe) {
...
//_____________________________________________________________________________
Double_t Intersection::DistFromOutside(Double_t *point, Double_t *dir, Int_t iact,
                              Double_t step, Double_t *safe) const
{
// Compute distance from a given point outside to the shape.
   if (iact<3 && safe) {
...
//_____________________________________________________________________________
Int_t Intersection::GetNpoints() const
{
...
//_____________________________________________________________________________
Double_t Intersection::Safety(Double_t *point, Bool_t in) const
{
// Compute safety distance for a union node;
   Double_t local1[3], local2[3];
   fLeftMat->MasterToLocal(point,local1);
...
//_____________________________________________________________________________
void Intersection::SavePrimitive(ostream &out, Option_t *option /*= ""*/)
{
// Save a primitive as a C++ statement(s) on output stream "out".
   BoolNode::SavePrimitive(out,option);
   out << "   pBoolNode = new Intersection(";
   out << fLeft->GetPointerName() << ",";
   out << fRight->GetPointerName() << ",";
   if (!fLeftMat->IsIdentity()) out << fLeftMat->GetPointerName() << ",";
   else                         out << "0,";
...
//_____________________________________________________________________________
void Intersection::SetPoints(Double_t * /*points*/) const
{
// Fill buffer with shape vertices.
}

//_____________________________________________________________________________
void Intersection::SetPoints(Float_t * /*points*/) const
{
// Fill buffer with shape vertices.
}

//_____________________________________________________________________________
void Intersection::Sizeof3D() const
{
// Register 3D size of this shape.
   BoolNode::Sizeof3D();
}
