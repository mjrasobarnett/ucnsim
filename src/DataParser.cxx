...
bool DataParser::LoadFile(string filename)
{
	...
	if ( !in.is_open() ) {
	    cout << "DataParser::Constructor: could not open file: " << fFileName << endl;
	    cout << endl;
	    return false;
	}
...
bool DataParser::GetData(vector<string>& data, string searchstring) 
{
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//______________________________________________________________________________
bool DataParser::ConvertVectorInt(vector<string>& data, vector<unsigned int>& int_data)
{
	for (unsigned int i = 0; i < data.size(); i++) {   
...
//______________________________________________________________________________
bool DataParser::ConvertVectorDouble(vector<string>& data, vector<double>& double_data)
{
	for (unsigned int i = 0; i < data.size(); i++) {   
		istringstream ss(data[i]); 		// Using istringstream to convert string to type int
		double value;
