...
ClassImp(TUCNParabola)

TUCNParabola *TUCNParabola::fgParabola = NULL;

//_____________________________________________________________________________
TUCNParabola::TUCNParabola()
				 :TObject()
{
// Default constructor.
...
//_____________________________________________________________________________
TUCNParabola::TUCNParabola(const TUCNParabola& other)
				 :TObject(other)
{
// Copy constructor.
   Error("TUCNParabola","Copying not allowed for TUCNParabola");
} 
...
{
// Destructor.
   Info("TUCNParabola", "Destructor");
	fgParabola = NULL;
}   

//_____________________________________________________________________________
TUCNParabola &TUCNParabola::operator=(const TUCNParabola&)
{
// Assignment.
   Error("TUCNParabola","Assignment not allowed for TGeoBuilder");
   return *this;
}

//_____________________________________________________________________________
TUCNParabola *TUCNParabola::Instance() 
{
// Return pointer to singleton.  
   if (!fgParabola) fgParabola = new TUCNParabola();
	return fgParabola;
}   
