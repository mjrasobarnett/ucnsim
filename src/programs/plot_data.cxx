...
Int_t main(int argc, char **argv)
{
   ...
   if (runConfig.ObserveSpin() == kTRUE) {
      PlotSpinPolarisation(histDir, statenames, runConfig);
      PlotT2(histDir, statenames, runConfig);
   }
   
   //////////////////////////////////////////////////////////////////////////////////////
   // -- Bounce Data
   if (runConfig.ObserveBounces() == kTRUE) {
      PlotBounceCounters(histDir, statenames, runConfig);
   }
   //////////////////////////////////////////////////////////////////////////////////////
   // -- Track History
   if (runConfig.ObserveTracks() == kTRUE) {
      PlotParticleHistories(histDir, statenames, runConfig, geoManager);
   }
   //////////////////////////////////////////////////////////////////////////////////////
   // -- Track History
   if (runConfig.ObserveField() == kTRUE) {
      PlotField(histDir, statenames, runConfig);
   }
   //////////////////////////////////////////////////////////////////////////////////////
*/   // -- Clean up and Finish
   file->Close();
...
void PlotSpinPolarisation(TDirectory* const histDir, const vector<TDirectory*> stateDirs, const RunConfig& runConfig) 
{
   ...
   spinUpAlongXHist = new TH1F(histname,"SpinUp AlongX", nbins, 0.0, runTime);      
   ...
   spinDownAlongXHist = new TH1F(histname,"SpinDown AlongX", nbins, 0.0, runTime);      
   ...
   spinUpDownAlongXHist  = new TH1F(histname,"SpinUp+Down Along X", nbins, 0.0, runTime);   
   ...
   spinAlphaX = new TGraph(nbins);
   
   //////////////////////////////////////////////////////////////////////////////////////
   // -- Y Axis Spin Polarisation
   sprintf(histname,"%s:SpinUp Along Y",stateDir->GetName());
   spinUpAlongYHist = new TH1F(histname,"SpinUp Along Y", nbins, 0.0, runTime);      
   ...
   spinDownAlongYHist = new TH1F(histname,"SpinDown Along Y", nbins, 0.0, runTime);      
   ...
   spinUpDownAlongYHist  = new TH1F(histname,"SpinUp+Down Along Y", nbins, 0.0, runTime);   
   ...
   spinAlphaY = new TGraph(nbins);
   
   //////////////////////////////////////////////////////////////////////////////////////
   // -- Z Axis Spin Polarisation
   sprintf(histname,"%s:SpinUp Along Z",stateDir->GetName());
   spinUpAlongZHist = new TH1F(histname,"SpinUp Along Z", nbins, 0.0, runTime);      
   ...
   spinDownAlongZHist = new TH1F(histname,"SpinDown Along Z", nbins, 0.0, runTime);      
   ...
   spinUpDownAlongZHist  = new TH1F(histname,"SpinUp+Down Along Z", nbins, 0.0, runTime);   
...
void PlotBounceCounters(TDirectory* const histDir, const vector<TDirectory*> stateDirs)
{
   ...
   bounceHist = new TH1F(histname,"Bounces", 100, 0.0, 100.0);
   sprintf(histname,"%s:Specular",stateDir->GetName());
   specHist = new TH1F(histname,"Specular", 100, 0.0, 100.0);
   sprintf(histname,"%s:Diffuse",stateDir->GetName());
   diffHist = new TH1F(histname,"Diffuse", 100, 0.0, 100.0);
   //////////////////////////////////////////////////////////////////////////////////////
   // -- cd into the State's folder
   stateDir->cd();
   //////////////////////////////////////////////////////////////////////////////////////
      ...
      if (cl->InheritsFrom("TDirectory")) {
         ...
         while ((objKey = static_cast<TKey*>(objIter.Next()))) {
            ...
            if (cl->InheritsFrom("BounceData")) {
               ...
               specHist->Fill(data->CountSpecular());
               diffHist->Fill(data->CountDiffuse());
               delete data;
            }
         }
      }
...
void PlotField(TDirectory* const histDir, const vector<TDirectory*> stateDirs, const RunConfig& runConfig)
{
   ...
   bxHist = new TH2F(histname,"Bx", 500, 4.998*Units::uT, 5.002*Units::uT, 500, 0.0, runTime);
   ...
   byHist = new TH2F(histname,"By", 500, -5.5*Units::uT, 5.5*Units::uT, 500, 0.0, runTime);
   ...
   bzHist = new TH2F(histname,"Bz", 500, -5.5*Units::uT, 5.5*Units::uT, 500, 0.0, runTime);
