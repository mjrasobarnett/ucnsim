...
Int_t empty_source_direct_to_detector()
{
...
*/   
   ...
   const char *fileName = "empty_source_direct_to_detector_geom.root";
   ...
   const char *visFileName = "empty_source_direct_to_detector_vis.root";
...
Bool_t BuildFields(const TGeoManager* geoManager)
{
   ...
   const char *fieldsFileName = "empty_source_direct_to_detector_fields.root";
