...
//   chamber->AddNode(centralElectrode, 1, new TGeoHMatrix(centralElectrodeMat));
   ...
   // HV Cell
   TUCNGeoTube *hvCellShape = new TUCNGeoTube("HVCellShape", hvCellRMin, hvCellRMax, hvCellHalfZ);
...
//   chamber->AddNode(hvElectrode, 1, new TGeoHMatrix(hvElectrodeMat));
   ...
   const char *fileName = "$(UCN_GEOM)/cryoedm_fill_cells_geom.root";
   ...
   const char *visFileName = "$(UCN_GEOM)/cryoedm_fill_cells_vis.root";
