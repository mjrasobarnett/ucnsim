...
class TUCNGeoTube : public TUCNGeoBBox 
{
	...
	public:
	   ...
	   virtual ~TUCNGeoTube();
		...
		// methods
		virtual void 			 TimeFromInside() const { Info("TimeFromInside", ""); }
...
class TUCNGeoTubeSeg : public TUCNGeoTube
{
protected:
   // data members
...
public:
   // constructors
   TUCNGeoTubeSeg();
   TUCNGeoTubeSeg(Double_t rmin, Double_t rmax, Double_t dz, 
               Double_t phi1, Double_t phi2);
   TUCNGeoTubeSeg(const char * name, Double_t rmin, Double_t rmax, Double_t dz, 
               Double_t phi1, Double_t phi2);
   TUCNGeoTubeSeg(Double_t *params);
   // destructor
   virtual ~TUCNGeoTubeSeg();

   // methods
   void TimeFromInside() const { Info("TimeFromInside", ""); }
   ...
   ClassDef(TUCNGeoTubeSeg, 1)         // cylindrical tube segment class 
};

////////////////////////////////////////////////////////////////////////////
//                                                                        //
// TUCNGeoCtub - a tube segment cut with 2 planes. Has 11 parameters :       //
...
class TUCNGeoCtub : public TUCNGeoTubeSeg
{
protected:
   // data members
...
public:
   // constructors
   TUCNGeoCtub();
   TUCNGeoCtub(Double_t rmin, Double_t rmax, Double_t dz, Double_t phi1, Double_t phi2,
            Double_t lx, Double_t ly, Double_t lz, Double_t tx, Double_t ty, Double_t tz);
   TUCNGeoCtub(const char *name, Double_t rmin, Double_t rmax, Double_t dz, Double_t phi1, Double_t phi2,
            Double_t lx, Double_t ly, Double_t lz, Double_t tx, Double_t ty, Double_t tz);
   TUCNGeoCtub(Double_t *params);
   // destructor
   virtual ~TUCNGeoCtub();
   ...
   ClassDef(TUCNGeoCtub, 1)         // cut tube segment class 
};
