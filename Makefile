...
UCNLIB	 	= -L./lib -lUCN -L$(ROOTSYS)/lib -lEG -lGeom
#------------------------------------------------------------------------------
OBJS         = $(SANDBOXO) $(UCNSIMO) $(FITDATAO) $(TUCNGEOMANAGERO) $(TUCNGEONAVIGATORO) $(TUCNGEOBUILDERO) $(TUCNGEOBBOXO) $(TUCNGEOTUBEO) \
					$(TUCNGEOMATERIALO) $(TUCNGRAVFIELDO) $(TUCNPARTICLECLOUDO) $(TUCNPARTICLEO) $(TUCNDATAPARSERO) $(TUCNPARABOLAO) \
					$(TUCNEXPERIMENTO) $(TUCNPOLYNOMIALO) 
...
$(SANDBOX):	$(SANDBOXO) $(TUCNGEOMANAGERO) $(TUCNGEONAVIGATORO) $(TUCNGEOBUILDERO) $(TUCNGEOBBOXO) $(TUCNGEOTUBEO) $(TUCNGEOMATERIALO) \
 				$(TUCNGRAVFIELDO) $(TUCNPARTICLECLOUDO) $(TUCNPARTICLEO) $(TUCNEXPERIMENTO) $(TUCNPARABOLAO) $(TUCNPOLYNOMIALO)
...
$(UCNSO):	$(TUCNGEOMANAGERO) $(TUCNGEONAVIGATORO) $(TUCNGEOBUILDERO) $(TUCNGEOBBOXO) $(TUCNGEOTUBEO) $(TUCNGEOMATERIALO) $(TUCNGRAVFIELDO) \
				$(TUCNPARTICLECLOUDO) $(TUCNPARTICLEO) $(TUCNEXPERIMENTO) $(TUCNDATAPARSERO) $(TUCNPARABOLAO) $(TUCNPOLYNOMIALO)
